    ...
    >
      ...
      <Modal.Body>
        <div className="d-flex justify-content-center flex-column align-items-center mt-5">
          <h5>WickYick Terms of Use </h5>
          <h5>Last revised on: March 5, 2022 </h5>
        </div>
        <div className="px-5">
          <p className="mt-3">
            The website located at www.wickyick.com (the “<strong>Site</strong>
            ”) is a copyrighted work belonging to WickYick, Inc. (“
            <strong>Company</strong>”, “<strong>us</strong>”, “
            <strong>our</strong>”, and “<strong>we</strong>
            ”).&nbsp;&nbsp;Certain features of the Site may be subject to
            additional guidelines, terms, or rules, which will be posted on the
            Site in connection with such features.&nbsp;&nbsp;All such
          ...
          <p className="mt-3">
            ...
            yourself or the entity that you represent).&nbsp;&nbsp;you may not
            access or use the Site or accept the Terms if you are not at least
            18 years old.&nbsp;&nbsp;If you do not agree with all of the
          ...
          <ol>
            <li>
              ...
              <ol>
                <li className="mt-2 pt-3">
                  <strong>Account Creation.&nbsp;&nbsp;</strong>In order to use
                  certain features of the Site, you must register for an account
                  (“<strong>Account</strong>”) and provide certain information
                  about yourself as prompted by the account registration
                  ...
                  Site.&nbsp;&nbsp;Company may suspend or terminate your Account
                  in accordance with Section 8.&nbsp;
                </li>
                <li>
                  <strong>Account Responsibilities.</strong> &nbsp;You are
                  responsible for maintaining the confidentiality of your
                  Account login information and are fully responsible for all
                  activities that occur under your Account.&nbsp;&nbsp;You agree
                  to immediately notify Company of any unauthorized use, or
            ...
            <li className="mt-2 pt-3">
              ...
              <ol>
                <li className="mt-2 pt-3">
                  <strong>License.&nbsp;</strong> Subject to these Terms,
                ...
                <li className="mt-2 pt-3">
                  <strong>Modification.</strong> &nbsp;Company reserves the
                  right, at any time, to modify, suspend, or discontinue the
                  Site (in whole or in part) with or without notice to
                ...
                <li className="mt-2 pt-3">
                  ...
                  acknowledge and agree that Company will have no obligation to
                  provide you with any support or maintenance in connection with
                  the Site.
                </li>
                <li className="mt-2 pt-3">
                  <strong>Ownership.&nbsp;&nbsp;</strong>Excluding any User
                  Content that you may provide (defined below), you acknowledge
                  ...
                  granted in these Terms.&nbsp;&nbsp;There are no implied
            ...
            <li className="mt-2 pt-3">
              ...
              <ol>
                <li className="mt-2 pt-3">
                  ...
                  and content that a user submits to, or uses with, the Site
                  (e.g., content in the user’s profile or
                  postings).&nbsp;&nbsp;You are solely responsible for your User
                  Content.&nbsp;&nbsp;You assume all risks associated with use
                  of your User Content, including any reliance on its accuracy,
                  completeness or usefulness by others, or any disclosure of
                  your User Content that personally identifies you or any third
                  party.&nbsp;&nbsp;You hereby represent and warrant that your
                  User Content does not violate our Acceptable Use Policy
                  (defined in Section 3.3).&nbsp;&nbsp;You may not represent or
                  imply to others that your User Content is in any way provided,
                  sponsored or endorsed by Company.&nbsp;&nbsp;Because you alone
                  ...
                  backup any User Content, and your User Content may be deleted
                  at any time without prior notice.&nbsp;&nbsp;You are solely
                  responsible for creating and maintaining your own backup
                  copies of your User Content if you desire.
                </li>
                <li className="mt-2 pt-3">
                  <strong>License.</strong> &nbsp;You hereby grant (and you
                  ...
                  Site.&nbsp;&nbsp;You hereby irrevocably waive (and agree to
                  cause to be waived) any claims and assertions of moral rights
                  or attribution with respect to your User Content.
                </li>
                <li className="mt-2 pt-3">
                  <strong>Acceptable Use Policy.&nbsp;&nbsp;</strong>The
                  ...
                  <ol>
                    ...
                    <li>
                      ...
                      (iii)&nbsp;&nbsp;use the Site to harvest, collect, gather
                      or assemble information or data regarding other users,
                      including e-mail addresses, without their consent; (iv)
                      ...
                      software or automated agents or scripts to produce
                      ...
                      archives of such materials, subject to the parameters set
                      forth in our robots.txt file).
                    </li>
                  </ol>
                </li>
                <li className="mt-2 pt-3">
                  <strong>Enforcement.&nbsp;&nbsp;</strong>We reserve the right
                ...
                <li className="mt-2 pt-3">
                  <strong>Feedback.</strong> &nbsp;If you provide Company with
                  any feedback or suggestions regarding the Site (“
                  <strong>Feedback</strong>”), you hereby assign to Company all
                  rights in such Feedback and agree that Company shall have the
                  right to use and fully exploit such Feedback and related
                  information in any manner it deems
                  appropriate.&nbsp;&nbsp;Company will treat any Feedback you
                  provide to Company as non-confidential and
                  non-proprietary.&nbsp;&nbsp;You agree that you will not submit
                  to Company any information or ideas that you consider to be
                  confidential or proprietary.
                </li>
              </ol>
            </li>
            <li className="mt-2 pt-3">
              <strong>Indemnification. &nbsp;&nbsp;</strong>You agree to
              indemnify and hold Company (and its officers, employees, and
              ...
              Content.&nbsp;&nbsp;Company reserves the right, at your expense,
              ...
              with our defense of these claims.&nbsp;&nbsp;You agree not to
              settle any matter without the prior written consent of
              Company.&nbsp;&nbsp;Company will use reasonable efforts to notify
            ...
            <li className="mt-2 pt-3">
              ...
              <ol>
                <li className="mt-2 pt-3">
                  ...
                  ”).&nbsp;&nbsp;Such Third-Party Links &amp; Ads are not under
                  the control of Company, and Company is not responsible for any
                  Third-Party Links &amp; Ads.&nbsp;&nbsp;Company provides
                  access to these Third-Party Links &amp; Ads only as a
                  ...
                  Third-Party Links &amp; Ads at your own risk, and should apply
                  a suitable level of caution and discretion in doing so. When
                  you click on any of the Third-Party Links &amp; Ads, the
                  applicable third party’s terms and policies apply, including
                  the third party’s privacy and data gathering
                  practices.&nbsp;&nbsp;You should make whatever investigation
                ...
                <li className="mt-2 pt-3">
                  ...
                  Content.&nbsp;&nbsp;Because we do not control User Content,
                  you acknowledge and agree that we are not responsible for any
                  User Content, whether provided by you or by
                  others.&nbsp;&nbsp;We make no guarantees regarding the
                  accuracy, currency, suitability, or quality of any User
                  Content.&nbsp;&nbsp;Your interactions with other Site users
                  are solely between you and such users.&nbsp;&nbsp;You agree
                  that Company will not be responsible for any loss or damage
                ...
                <li className="mt-2 pt-3">
                  <strong>Release.&nbsp;</strong> You hereby release and forever
                  discharge the Company (and our officers, employees, agents,
                  successors, and assigns) from, and hereby waive and
                  ...
                  any Third-Party Links &amp; Ads).&nbsp;&nbsp;IF YOU ARE A
          ...
          <p className="px-4">
            ...
            OR OTHER HARMFUL CODE, COMPLETE, LEGAL, OR SAFE.&nbsp;&nbsp;IF
          ...
          <p className="px-4">
            ...
            OF THE POSSIBILITY OF SUCH DAMAGES.&nbsp;&nbsp;ACCESS TO, AND USE
          ...
          <p className="px-4">
            ...
            OF MORE THAN ONE CLAIM WILL NOT ENLARGE THIS LIMIT.&nbsp;&nbsp;YOU
          ...
          <ol>
            <li className="mt-2 pt-3">
              ...
              Section, these Terms will remain in full force and effect while
              you use the Site.&nbsp;&nbsp;We may suspend or terminate your
              ...
              Site in violation of these Terms.&nbsp;&nbsp;Upon termination of
              ...
              your User Content.&nbsp;&nbsp;Even after your rights under these
              Terms are terminated, the following provisions of these Terms will
              remain in effect: Sections 2.2 through 2.5, Section 3 and Sections
              4 through 10.
            </li>
            <li className="mt-2 pt-3">
          ...
          <p className="mt-2  px-4">
            ...
            users of our Site do the same.&nbsp;&nbsp;In connection with our
            Site, we have adopted and implemented a policy respecting copyright
            law that provides for the removal of any infringing materials and
            for the termination, in appropriate circumstances, of users of our
            online Site who are repeat infringers of intellectual property
            rights, including copyrights.&nbsp;&nbsp;If you believe that one of
          ...
          <ol>
            <li className="mt-2">your physical or electronic signature;</li>
            <li className="mt-2">
          ...
          <p>The designated Copyright Agent for Company is: Alan Moore</p>
          <p>Designated Agent: Alan Moore</p>
          <p>Address of Agent: 1381 Constance Street, New Orleans, LA 70130</p>
          <p>Telephone: (310) 526-3833</p>
          <p>Email: alanbmoore@wickyick.com</p>
          <p>&nbsp; &nbsp;&nbsp;</p>
          <ol>
            <li>
              ...
              <ol>
                <li className="mt-2">
                  <strong>Changes.</strong> &nbsp;These Terms are subject to
                  occasional revision, and if we make any substantial changes,
                  we may notify you by sending you an e-mail to the last e-mail
                  ...
                  address.&nbsp;&nbsp;In the event that the last e-mail address
                  ...
                  will be effective upon the earlier of thirty (30) calendar
                  days following our dispatch of an e-mail notice to you (if
                  applicable) or thirty (30) calendar days following our posting
                  of notice of the changes on our Site.&nbsp;&nbsp;These changes
                  will be effective immediately for new users of our
                  Site.&nbsp;&nbsp;Continued use of our Site following notice of
                  such changes shall indicate your acknowledgement of such
                  changes and agreement to be bound by the terms and conditions
                  of such changes.
                </li>
                <li className="mt-2">
                  <strong>
                    ...
                    <em>
                      ...
                      carefully.&nbsp;&nbsp;It is part of your contract with
                  ...
                  <ol>
                    <li className="mt-2">
                      <em>Applicability of Arbitration Agreement.</em> &nbsp;All
                      claims and disputes (excluding claims for injunctive or
                      other equitable relief as set forth below) in connection
                      with the Terms or the use of any product or service
                      provided by the Company that cannot be resolved informally
                      or in small claims court shall be resolved by binding
                      arbitration on an individual basis under the terms of this
                      Arbitration Agreement.&nbsp;&nbsp;Unless otherwise agreed
                      ...
                      users or beneficiaries of services or goods provided under
                      the Terms.
                    </li>
                    <li className="mt-2">
                      <em>
                      ...
                      party must first send to the other party a written Notice
                      of Dispute (<strong>“Notice”</strong>) describing the
                      nature and basis of the claim or dispute, and the
                      requested relief.&nbsp;&nbsp;A Notice to the Company
                      should be sent to: 1381 Constance Street, New Orleans,
                      Louisiana 70130.&nbsp;&nbsp;After the Notice is received,
                      you and the Company may attempt to resolve the claim or
                      dispute informally.&nbsp;&nbsp;If you and the Company do
                      ...
                      the arbitrator until after the arbitrator has determined
                      the amount of the award, if any, to which either party is
                      entitled.
                    </li>
                    <li className="mt-2">
                      Arbitration Rules.&nbsp;&nbsp;Arbitration shall be
                      initiated through the American Arbitration Association (
                      <strong>“AAA”</strong>), an established alternative
                      dispute resolution provider (
                      <strong>“ADR Provider”</strong>) that offers arbitration
                      as set forth in this section.&nbsp;&nbsp;If AAA is not
                      available to arbitrate, the parties shall agree to select
                      an alternative ADR Provider.&nbsp;&nbsp;The rules of the
                      ...
                      rules are in conflict with the Terms.&nbsp;&nbsp;The AAA
                      Consumer Arbitration Rules (
                      <strong>“Arbitration Rules”</strong>) governing the
                      arbitration are available online at{" "}
                      <a href="http://www.adr.org">www.adr.org</a> or by calling
                      the AAA at 1-800-778-7879.&nbsp;&nbsp;The arbitration
                      shall be conducted by a single, neutral
                      arbitrator.&nbsp;&nbsp;Any claims or disputes where the
                      total amount of the award sought is less than Ten Thousand
                      U.S. Dollars (US $10,000.00) may be resolved through
                      binding non-appearance-based arbitration, at the option of
                      ...
                      to a hearing will be determined by the Arbitration
                      Rules.&nbsp;&nbsp;Any hearing will be held in a location
                      within 100 miles of your residence, unless you reside
                      outside of the United States, and unless the parties agree
                      otherwise.&nbsp;&nbsp;If you reside outside of the U.S.,
                      the arbitrator shall give the parties reasonable notice of
                      the date, time and place of any oral hearings. Any
                      ...
                      award that is greater than the last settlement offer that
                      the Company made to you prior to the initiation of
                      arbitration, the Company will pay you the greater of the
                      award or $2,500.00.&nbsp;&nbsp;Each party shall bear its
                      own costs (including attorney’s fees) and disbursements
                      arising out of the arbitration and shall pay an equal
                    ...
                    <li className="mt-2">
                      ...
                      elected, the arbitration shall be conducted by telephone,
                      online and/or based solely on written submissions; the
                      specific manner shall be chosen by the party initiating
                      the arbitration.&nbsp;&nbsp;The arbitration shall not
                      involve any personal appearance by the parties or
                      witnesses unless otherwise agreed by the parties.
                    </li>
                    <li className="mt-2">
                      <em>Time Limits.</em> &nbsp;If you or the Company pursue
                    ...
                    <li className="mt-2">
                      <em>Authority of Arbitrator</em>.&nbsp;&nbsp;If
                      arbitration is initiated, the arbitrator will decide the
                      rights and liabilities, if any, of you and the Company,
                      and the dispute will not be consolidated with any other
                      ...
                      including the calculation of any damages
                      awarded.&nbsp;&nbsp;The arbitrator has the same authority
                      to award relief on an individual basis that a judge in a
                      court of law would have.&nbsp;&nbsp;The award of the
                      arbitrator is final and binding upon you and the Company.
                    </li>
                    <li className="mt-2">
                      <em>Waiver of Jury Trial.</em> &nbsp;THE PARTIES HEREBY
                      ...
                      applicable in a court and are subject to very limited
                      review by a court.&nbsp;&nbsp;In the event any litigation
                    ...
                    <li className="mt-2">
                      ...
                      THIS ARBITRATION AGREEMENT MUST BE ARBITRATED OR LITIGATED
                      ON AN INDIVIDUAL BASIS AND NOT ON A CLASS BASIS, AND
                    ...
                    <li className="mt-2">
                      <em>Confidentiality</em>.&nbsp;&nbsp;All aspects of the
                      arbitration proceeding, including but not limited to the
                      award of the arbitrator and compliance therewith, shall be
                      strictly confidential.&nbsp;&nbsp;The parties agree to
                      maintain confidentiality unless otherwise required by
                    ...
                    <li className="mt-2">
                      <em>Severability</em>.&nbsp;&nbsp;If any part or parts of
                    ...
                    <li className="mt-2">
                      ...
                      may seek emergency equitable relief before a state or
                    ...
                    <li className="mt-2">
                      <em>Courts.</em> &nbsp;In any circumstances where the
                      ...
                      Orleans County, Louisiana, for such purpose&nbsp;
                    </li>
                  </ol>
                </li>
                <li className="mt-3">
                  <strong>Export.&nbsp;</strong>The Site may be subject to U.S.
                  ...
                  technical data acquired from Company, or any products
                  utilizing such data, in violation of the United States export
                  laws or regulations.&nbsp;
                </li>
                <li className="mt-3">
                  <strong>Disclosures.</strong> &nbsp;Company is located at the
                  address in Section 10.8. If you are a California resident, you
                ...
                <li className="mt-3">
                  ...
                  partner of the other.&nbsp;&nbsp;These Terms, and your rights
                  ...
                  foregoing will be null and void.&nbsp;&nbsp;Company may freely
                  assign these Terms.&nbsp;&nbsp;The terms and conditions set
                  forth in these Terms shall be binding upon assignees.&nbsp;
                </li>
                <li className="mt-3">
                  <strong>Copyright/Trademark Information</strong>
                  .&nbsp;&nbsp;Copyright © 2022 WickYick, Inc. All rights
                  reserved.&nbsp;&nbsp;All trademarks, logos and service marks
                  (“<strong>Marks</strong>”) displayed on the Site are our
